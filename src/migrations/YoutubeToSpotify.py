...
class Migrator:
    ...
    def __init__(self):
        ...
        self._spotify_matches = None

    def execute(self):
        self._get_playlist_from_input()
    ...
    def _get_playlist_from_input(self):
        ...
        self._youtube_playlist = self.YoutubeAPI.get_playlist_items(selectedPlaylistId)['items']          # return all vids for selected playlist
        
    def _get_spotify_matches(self):
